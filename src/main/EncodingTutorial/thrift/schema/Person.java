 ...
 *  @generated
 */
package EncodingTutorial.thrift.schema;
...
public class Person implements org.apache.thrift.TBase<Person, Person._Fields>, java.io.Serializable, Cloneable, Comparable<Person> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<String> interests; // optional
  ...
  public int compareTo(Person other) {
    ...
    lastComparison = Boolean.compare(isSetFavoriteNumber(), other.isSetFavoriteNumber());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFavoriteNumber()) {
    ...
    lastComparison = Boolean.compare(isSetInterests(), other.isSetInterests());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInterests()) {
